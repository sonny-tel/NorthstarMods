...
void function SetupDefaultDevCommands()
{
	...
	SetupDevCommand(
		"Export precache script",
		"script_ui Dev_CommandLineAddParm( \"-autoprecache\", \"\" ); script_ui Dev_CommandLineRemoveParm( \"" + STARTPOINT_DEV_STRING + "\" ); reload"
	)
...
function DefineActionBlocks()
{
	...
	AddActionBlock(
		"Week 1",
		"Timed Switch Panel Run",
		"Sean",
		"Test your wallrunning abilities by jumping on timed platforms",
		"playlist Load a map on the command line; map sp_platform_test01"
	)
	AddActionBlock(
		"Week 1",
		"Energon Room",
		"Mackey",
		"Combat test arena. Collect all Energon Spheres to win",
		"playlist Load a map on the command line; map sp_abmac1"
	)
	...
	AddActionBlock(
		...
		"Jumping Puzzles",
		"ChadG",
		"Various pilot jumping puzzles with moving platforms",
		"playlist Load a map on the command line; mp_gamemode at; map mp_chad"
	)
	AddActionBlock(
		"Week 1",
		"FLANKER BOOST loadout basics",
		"Brent",
		"Non-wallrunning pilot jumping basics",
		"playlist Load a map on the command line; mp_gamemode at; map mp_ab_test"
	)
	...
	AddActionBlock(
		...
		"Environment Puzzles",
		"ChadG",
		"Get your titan to the exit by solving some puzzles",
		"playlist Load a map on the command line; mp_gamemode at; map mp_chad2"
	)
	...
	AddActionBlock(
		...
		"Creature Ship",
		"LumberJake",
		"Explore a crashed ship with mysterious cargo",
		"playlist Load a map on the command line; mp_gamemode at; map mp_actionblockjake01"
	)
	AddActionBlock(
		"Week 2",
		"Titan/Pilot Puzzles",
		"RyanR",
		"Get your titan to the green room",
		"playlist Load a map on the command line; mp_gamemode at; map mp_ryanr_actionblock_01"
	)
	...
	AddActionBlock(
		...
		"Titan Overwatch",
		"Roger",
		"Your sniping titan will cover you as you advance to the bunker",
		"playlist Load a map on the command line; map sp_ab_titanbuddy"
	)
	AddActionBlock(
		"Week 2",
		"Rodeo Express",
		"Chin",
		"Use your titan to get you through a pilot hazard area",
		"playlist lava; mp_gamemode at; map mp_chin_rodeo_express"
	)
	AddActionBlock(
		"Week 2",
		"Wallrun Gauntlet",
		"McCord",
		"Wallrun through the geo and don't fall to your death",
		"playlist Load a map on the command line; map sp_zipline_action_block01"
	)
	...
	AddActionBlock(
		"Week 2",
		"Smart Targeted Switch Panels",
		"Sean",
		"Wallrun from wall to wall while activating switches",
		"playlist Load a map on the command line; map sp_platform_test02"
	)
	...
	AddActionBlock(
		...
		"Titan v Titan",
		"Roger",
		"Test Titan vs Titan combat against various titan AI",
		"playlist Load a map on the command line; map sp_ab_tvt"
	)
	AddActionBlock(
		"Week 3",
		"Train Raid",
		"ChadG",
		"Board a speeding train and hack the explosives on board",
		"playlist Load a map on the command line; map sp_ab_trainride01"
	)
	AddActionBlock(
		"Week 3",
		"Super Spectre Bros",
		"David",
		"Survive 6 waves against super spectres",
		"playlist Load a map on the command line; map mp_ab_super_spectre_bros"
	)
	...
	// -Use low sensitivity. \n -Use bug_reproNum 1 to invert flight controls.\n -Use bug_reproNum 2 for PRO flight controls.
	// (free look) \n -Use bug_reproNum 3 for inverted PRO flight controls.", 											"playlist Load a map on the command
	// line; map sp_ab_week4" )
	...
	AddActionBlock(
		...
		"Fastball Special",
		"Slayback/McCord",
		"Use a new Titan ability to hurl yourself to new heights.",
		"playlist Load a map on the command line; map sp_fastball"
	)
	AddActionBlock(
		"Week 4",
		"Time Travel Mechanic",
		"LumberJake",
		"Travel back and forth through time to complete your mission.",
		"playlist Load a map on the command line; map sp_actionblockjake02"
	)
	AddActionBlock(
		"Week 5",
		"Titan Ability: Death Blossom",
		"Mo",
		"Use Up on D-Pad to use Death Blossom\n\nUse your new ability to defeat the enemies",
		"playlist Load a map on the command line; bug_reproNum 0; map sp_ab_blossom"
	)
	AddActionBlock(
		"Week 5",
		"Titan Ability: Arc Blast",
		"Mo",
		"Use Down on D-Pad to use Arc Blast\n\nUse your new ability to defeat the enemies",
		"playlist Load a map on the command line; bug_reproNum 1; map sp_ab_blossom"
	)
	AddActionBlock(
		"Week 5",
		"Titan Abilities: Death Blossom + Arc Blast",
		"Mo",
		"D-Pad Up = Death Blossom\nD-Pad Down = Arc Blast\n\nUse your new abilities to defeat the enemies",
		"playlist Load a map on the command line; bug_reproNum 2; map sp_ab_blossom"
	)
	AddActionBlock(
		"Week 5",
		"Time Stasis Gun",
		"LumberJake",
		"Titan freezes enemies allowing the Pilot \nto do a one-shot kill",
		"playlist Load a map on the command line; map sp_actionblockjake03"
	)
	AddActionBlock(
		"Week 5",
		"Fastball Mortar Battle",
		"McCord/Slayback",
		"Freeform Buddy Titan arena battle. \n - Fastball Special \n - Mortar Crews \n - Buddy Hibernation \n - Harvester Defense",
		"playlist Load a map on the command line; map sp_ab_mortar_battle01"
	)
	AddActionBlock(
		"Week 5",
		"Zipline Gun",
		"ChadG",
		"Create permanent ziplines in the map",
		"playlist Load a map on the command line; mp_gamemode tdm; bug_reproNum 1234; map mp_angel_city"
	)
	AddActionBlock(
		"Week 6",
		"Titan Hulk",
		"David",
		"Buddy Titan hulks out and throws things.",
		"playlist Load a map on the command line; map sp_ab_titan_thrower"
	)
	AddActionBlock(
		"Week 6",
		"Player & Titan vs Enemy Titan",
		"Roger",
		"Bare bones Pilot & Auto Titan vs Enemy Titan",
		"playlist Load a map on the command line; map sp_ab_ptvt"
	)
	AddActionBlock(
		"Week 6",
		"Pilot Stasis Gun",
		"Soupy",
		"Pilot has a Stasis gun to help a friendly Titan out",
		"playlist Load a map on the command line; map sp_ab_synergy"
	)
	AddActionBlock(
		"Week 6",
		"Acid Rain",
		...
		"map sp_actionblockjake04"
	)
	AddActionBlock(
		"Week 6",
		"Freeform Hallway Fight",
		"McCord/Slayback",
		"Move through the tight hallways with your Titan Buddy.",
		"playlist Load a map on the command line; map sp_ab_hallway_fight01"
	)
	AddActionBlock(
		"Week 6",
		"Stealth Town",
		"Carlos",
		"Stealth through a group of enemy titans",
		"playlist Load a map on the command line; map sp_titan_stealth"
	)
	AddActionBlock(
		"Week 6",
		"Titan Attack Command",
		"Mo",
		"Command your buddy titan to attack a position.",
		"playlist Load a map on the command line; map sp_ab_break"
	)
	AddActionBlock( "Week 7", "SP Shell", "Chad/McCord", "", "playlist Load a map on the command line; map sp_shell1" )
	AddActionBlock(
		"Week 7",
		"Smart Pistol Progression",
		"Soupy",
		"Try different smart pistol mods in different combat situations",
		"playlist Load a map on the command line; map sp_ab_smart_pistol_ramp"
	)
}
