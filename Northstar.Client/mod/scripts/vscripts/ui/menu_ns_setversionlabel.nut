...
void function NS_SetVersionLabel()
{
        ...
        Hud_SetText( versionLabel, "v" + NSGetModVersionByModName("Northstar.Client") + "\n" + GetPublicGameVersion()) //Sets the label text (Getting Northstar version from Northstar.Client)
}
